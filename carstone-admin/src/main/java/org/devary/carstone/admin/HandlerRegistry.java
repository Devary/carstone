...
/**
 * Resolves, per entity name, the {@code CrudHandler} bean whose {@code @CrudstoneResource}
 * targets it. EntityResource delegates here first and only falls back to the generic
 * EntityStore when an entity has no registered override. Ported from quar-crud-host.
 */
@Startup
@ApplicationScoped
